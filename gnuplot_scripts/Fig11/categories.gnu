...
plot 'counts.txt' u 3:xtic(1) lc 'grey' w boxes t "Total users", '' u 2:xtic(1) w boxes ti "Users w sensitive/personal notes" lc 'pink', '' u 4:xtic(1) w points axes x1y2 ti "Affected users" lc -1
set output "trans_uc.png"
set yrange [1:1000000000]
set y2range [5:15]
plot 'counts.txt' u 6:xtic(1) lc 'grey' w boxes t "Total notes", '' u 5:xtic(1) w boxes ti "Sensitive/personal notes" lc 'pink', '' u 7:xtic(1) w points axes x1y2 ti "Percentage notes" lc -1
